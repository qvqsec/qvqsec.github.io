...
## Introduction
This is a short story about how a simple misconfiguration can lead to serious personal data exposure. To set the scene, I was asked by a friend to make a booking on a sports platform, but whilst navigating the site I discovered something rather alarming.

I've made a booking once before on this website, however I hadn't used any of the other functionality it offered. If I'm being honest, this platform is probably riddled with security flaws.
...
As soon, as the page loaded, I was pretty gobsmacked. As a member, I was able to see the following information; Full names, Email Addresses and Phone numbers.
...
I navigated directly to the exposed endpoint `frm<REDACTED>.aspx` and discover there is no controls as to who can access this page.
